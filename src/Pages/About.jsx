  ...
  return (
    <div>
      ...
      <div className="mb-20 flex flex-col md:flex-row">
        <div className="hp flex cursor-pointer flex-col gap-5 border px-10 py-8 text-[15] text-gray-600 transition-all duration-300 hover:bg-primary hover:text-white sm:py-16">
          <b>EFFICIENCY:</b>
          <p>
